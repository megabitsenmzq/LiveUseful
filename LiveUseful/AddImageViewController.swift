...
//        MSAnalytics.trackEvent("Add Image")
    ...
    func imagePicker(imagePicker: LImagePicker, pickedImage: UIImage) {
        ...
        imageViewInScrollView.image = pickedImage
        imageViewInScrollView.frame.size = pickedImage.size
        scrollView.minimumZoomScale = getMinimumZoomScale(image: pickedImage)
        scrollView.zoomScale = scrollView.minimumZoomScale
        scrollView.contentOffset.x = pickedImage.size.width * scrollView.minimumZoomScale / 2 - view.frame.width / 2
        scrollView.contentOffset.y = pickedImage.size.height * scrollView.minimumZoomScale / 2 - view.frame.height / 2
